...
- Los colores comerciales ORO, ORO V200, ESMERILADO y ORO ENVEJECIDO ESMERILADO son colores validos aunque no tengan codigo RAL. Devuelve su nombre exacto en color. Si el usuario dice "RAL ORO", devuelve "ORO".
