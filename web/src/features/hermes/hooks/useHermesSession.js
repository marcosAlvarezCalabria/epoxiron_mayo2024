...
import { createHermesSession, getHermesSession, sendHermesMessage, confirmHermesProposal, rejectHermesProposal } from "@/application/use-cases";
export const useHermesSession = (sessionId) => {
    ...
    const sendMessageMutation = useMutation({
        mutationFn: async (content) => sendHermesMessage(sessionId, content),
        onSuccess: (data) => {
