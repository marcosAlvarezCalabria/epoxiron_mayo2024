...
export const DeliveryNotesPage = () => {
    ...
    return (_jsxs("section", { className: "space-y-6", children: [_jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-slate-400", children: "Albaranes" }), _jsx("h2", { className: "text-3xl font-semibold tracking-tight text-white", children: "Cola de albaranes" }), _jsx("p", { className: "mt-2 max-w-2xl text-sm text-slate-400", children: "Gestion de trabajos con seleccion de cliente, calculo de precios y numeracion automatica." })] }), _jsxs("button", { className: "inline-flex items-center justify-center gap-2 rounded-xl border border-cyan-400/30 bg-cyan-400/10 px-4 py-3 text-sm font-semibold text-cyan-50", onClick: () => {
                            setEditingNoteId(null);
                            setForm(emptyForm());
                            setCustomerSearch("");
                            setPreviews({});
                            ...
                            setIsComposerOpen(true);
                                        ...
                                        }, children: [_jsxs("div", { className: "sticky top-0 z-10 -mx-5 -mt-5 mb-5 flex items-center justify-between gap-3 border-b border-white/10 bg-[#0b1220]/95 px-5 py-4 backdrop-blur sm:-mx-6 sm:-mt-6 sm:px-6", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-cyan-300", children: editingNoteId ? "Editar albaran" : "Nuevo albaran" }), _jsx("h3", { className: "mt-1 text-xl font-bold text-white", children: editingNoteId ? "Actualizar trabajo" : "Nuevo trabajo" })] }), _jsx("button", { className: "rounded-2xl border border-white/10 px-4 py-2 text-sm text-gray-300", onClick: () => {
                                                            setEditingNoteId(null);
                                                            setForm(emptyForm());
                                                            setCustomerSearch("");
                                                            setPreviews({});
